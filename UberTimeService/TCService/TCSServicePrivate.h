...
@property (nonatomic, readonly) NSInteger utsDataVersion;
...
@property (nonatomic, readonly) BOOL startTimeProvided;
@property (nonatomic, readonly) NSTimeInterval utsDuration;
@end
